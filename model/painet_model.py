...
class Painet(BaseModel):
    ...
    def set_input(self, input):
        ...
        if len(self.gpu_ids) > 0:
            self.input_P1 = input_P1(self.gpu_ids[0], non_blocking=True)
            self.input_BP1 = input_BP1(self.gpu_ids[0], non_blocking=True)
            self.input_SPL1 = input_SPL1(self.gpu_ids[0], non_blocking=True)
            self.input_P2 = input_P2(self.gpu_ids[0], non_blocking=True)
            self.input_BP2 = input_BP2(self.gpu_ids[0], non_blocking=True)
            self.input_SPL2 = input_SPL2(self.gpu_ids[0], non_blocking=True)
            self.label_P2 = label_P2(self.gpu_ids[0], non_blocking=True)
