...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--eval_iters_freq', type=int, default=50, help='frequency of showing training results on screen')
        ...
        parser.add_argument('--save_iters_freq', type=int, default=200, help='frequency of saving checkpoints at the end of epochs')
